...
class _StatsPageState extends State<StatsPage> {
  ...
  Future<void> _loadStats() async {
    try {
      ...
      if (data != null) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text('No stats found.')));
      }
    } catch (e) {
      ScaffoldMessenger.of(
        context,
  ...
  Future<void> _saveStats() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Failed to save stats: $e')));
    }
  }
                  ...
                  child: Column(
                    children: [
                      StatRow(
                        ...
                        onDecrement:
                            () => _updateStat('gamesPlayed', increment: false),
                      ),
                      StatRow(
                        title: 'Total Strokes',
                        ...
                        onDecrement:
                            () => _updateStat('totalStrokes', increment: false),
                      ),
                      StatRow(
                        title: 'Birdies',
                        ...
                        onDecrement:
                            () => _updateStat('birdies', increment: false),
                      ),
                      StatRow(
                        title: 'Pars',
                        ...
                        onDecrement:
                            () => _updateStat('pars', increment: false),
                      ),
                      StatRow(
                        title: 'Bogeys',
                        ...
                        onDecrement:
                            () => _updateStat('bogeys', increment: false),
                      ),
                      ...
                      ElevatedButton.icon(
                        onPressed: () {
                          setState(() {
                            _playerStats =
                                PlayerStats(); // Assumes default constructor will reset all
                            _statsChanged = true;
                          });
                        },
